...
public class TaskPipelineCoreConfig {
    ...
    public TaskPipelineCoreConfig( String zkConnectStr, int sessionTimeout, int baseSleepTimeMs, int maxRetries, int corePoolSize, int maxthreadPoolSize, int keepApiveTime, int queueSize) {
